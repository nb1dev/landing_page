...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  CREATE INDEX "pages_blocks_legal_doc_sections_clauses_order_idx" ON "pages_blocks_legal_doc_sections_clauses" USING btree ("_order");
  CREATE INDEX "pages_blocks_legal_doc_sections_clauses_parent_id_idx" ON "pages_blocks_legal_doc_sections_clauses" USING btree ("_parent_id");
  CREATE UNIQUE INDEX "pages_blocks_legal_doc_sections_clauses_locales_locale_paren" ON "pages_blocks_legal_doc_sections_clauses_locales" USING btree ("_locale","_parent_id");
  CREATE INDEX "_pages_v_blocks_legal_doc_sections_clauses_order_idx" ON "_pages_v_blocks_legal_doc_sections_clauses" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_legal_doc_sections_clauses_parent_id_idx" ON "_pages_v_blocks_legal_doc_sections_clauses" USING btree ("_parent_id");
  CREATE UNIQUE INDEX "_pages_v_blocks_legal_doc_sections_clauses_locales_locale_pa" ON "_pages_v_blocks_legal_doc_sections_clauses_locales" USING btree ("_locale","_parent_id");`)
}
