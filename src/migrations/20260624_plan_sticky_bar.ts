...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE UNIQUE INDEX "pages_blocks_plan_sticky_bar_plans_locales_locale_parent_id_u" ON "pages_blocks_plan_sticky_bar_plans_locales" USING btree ("_locale","_parent_id");
  ...
  CREATE UNIQUE INDEX "_pages_v_blocks_plan_sticky_bar_plans_locales_locale_parent_i" ON "_pages_v_blocks_plan_sticky_bar_plans_locales" USING btree ("_locale","_parent_id");
