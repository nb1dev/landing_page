...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  await db.run(sql`CREATE TABLE \`pages_blocks_mission_banner_images\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`image_id\` integer,
  	FOREIGN KEY (\`image_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`pages_blocks_mission_banner\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_mission_banner_images_order_idx\` ON \`pages_blocks_mission_banner_images\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_mission_banner_images_parent_id_idx\` ON \`pages_blocks_mission_banner_images\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_mission_banner_images_image_idx\` ON \`pages_blocks_mission_banner_images\` (\`image_id\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_mission_banner\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_mission_banner_order_idx\` ON \`pages_blocks_mission_banner\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_mission_banner_parent_id_idx\` ON \`pages_blocks_mission_banner\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_mission_banner_path_idx\` ON \`pages_blocks_mission_banner\` (\`_path\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_mission_banner_logo_idx\` ON \`pages_blocks_mission_banner\` (\`logo_id\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_welcome_banner_banner_labels\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`text_label\` text,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`pages_blocks_welcome_banner\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_welcome_banner_banner_labels_order_idx\` ON \`pages_blocks_welcome_banner_banner_labels\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_welcome_banner_banner_labels_parent_id_idx\` ON \`pages_blocks_welcome_banner_banner_labels\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_welcome_banner\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	...
  	\`access_button_label\` text,
  	\`access_button_url\` text,
  	\`details_button_label\` text,
  	\`details_button_url\` text,
  	\`copyright_text\` text,
  	\`line_text\` text,
  	\`block_name\` text,
  	FOREIGN KEY (\`logo_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null,
  	FOREIGN KEY (\`background_image_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null,
  	FOREIGN KEY (\`background_image_mobile_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null,
  	FOREIGN KEY (\`box_image_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`pages\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_welcome_banner_order_idx\` ON \`pages_blocks_welcome_banner\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_welcome_banner_parent_id_idx\` ON \`pages_blocks_welcome_banner\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_welcome_banner_path_idx\` ON \`pages_blocks_welcome_banner\` (\`_path\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_welcome_banner_logo_idx\` ON \`pages_blocks_welcome_banner\` (\`logo_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_welcome_banner_background_image_idx\` ON \`pages_blocks_welcome_banner\` (\`background_image_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_welcome_banner_background_image_mobile_idx\` ON \`pages_blocks_welcome_banner\` (\`background_image_mobile_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_welcome_banner_box_image_idx\` ON \`pages_blocks_welcome_banner\` (\`box_image_id\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_details_banner_content\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`icon_id\` integer,
  	...
  	FOREIGN KEY (\`background_image_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null,
  	FOREIGN KEY (\`background_image_mobile_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null,
  	FOREIGN KEY (\`image_content_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`pages_blocks_details_banner\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_details_banner_content_order_idx\` ON \`pages_blocks_details_banner_content\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_details_banner_content_parent_id_idx\` ON \`pages_blocks_details_banner_content\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_details_banner_content_icon_idx\` ON \`pages_blocks_details_banner_content\` (\`icon_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_details_banner_content_background_image_idx\` ON \`pages_blocks_details_banner_content\` (\`background_image_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_details_banner_content_background_image_mob_idx\` ON \`pages_blocks_details_banner_content\` (\`background_image_mobile_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_details_banner_content_image_content_idx\` ON \`pages_blocks_details_banner_content\` (\`image_content_id\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_details_banner\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_details_banner_order_idx\` ON \`pages_blocks_details_banner\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_details_banner_parent_id_idx\` ON \`pages_blocks_details_banner\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_details_banner_path_idx\` ON \`pages_blocks_details_banner\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_form_custom_block\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_form_custom_block_order_idx\` ON \`pages_blocks_form_custom_block\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_form_custom_block_parent_id_idx\` ON \`pages_blocks_form_custom_block\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_form_custom_block_path_idx\` ON \`pages_blocks_form_custom_block\` (\`_path\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_form_custom_block_icon_idx\` ON \`pages_blocks_form_custom_block\` (\`icon_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_form_custom_block_form_idx\` ON \`pages_blocks_form_custom_block\` (\`form_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_mission_banner_images\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`image_id\` integer,
  	\`_uuid\` text,
  	FOREIGN KEY (\`image_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`_pages_v_blocks_mission_banner\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_mission_banner_images_order_idx\` ON \`_pages_v_blocks_mission_banner_images\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_mission_banner_images_parent_id_idx\` ON \`_pages_v_blocks_mission_banner_images\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_mission_banner_images_image_idx\` ON \`_pages_v_blocks_mission_banner_images\` (\`image_id\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_mission_banner\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_mission_banner_order_idx\` ON \`_pages_v_blocks_mission_banner\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_mission_banner_parent_id_idx\` ON \`_pages_v_blocks_mission_banner\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_mission_banner_path_idx\` ON \`_pages_v_blocks_mission_banner\` (\`_path\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_mission_banner_logo_idx\` ON \`_pages_v_blocks_mission_banner\` (\`logo_id\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_welcome_banner_banner_labels\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`text_label\` text,
  	\`_uuid\` text,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`_pages_v_blocks_welcome_banner\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_welcome_banner_banner_labels_order_idx\` ON \`_pages_v_blocks_welcome_banner_banner_labels\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_welcome_banner_banner_labels_parent_id_idx\` ON \`_pages_v_blocks_welcome_banner_banner_labels\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_welcome_banner\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_welcome_banner_order_idx\` ON \`_pages_v_blocks_welcome_banner\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_welcome_banner_parent_id_idx\` ON \`_pages_v_blocks_welcome_banner\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_welcome_banner_path_idx\` ON \`_pages_v_blocks_welcome_banner\` (\`_path\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_welcome_banner_logo_idx\` ON \`_pages_v_blocks_welcome_banner\` (\`logo_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_welcome_banner_background_image_idx\` ON \`_pages_v_blocks_welcome_banner\` (\`background_image_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_welcome_banner_background_image_mobile_idx\` ON \`_pages_v_blocks_welcome_banner\` (\`background_image_mobile_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_welcome_banner_box_image_idx\` ON \`_pages_v_blocks_welcome_banner\` (\`box_image_id\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_details_banner_content\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`icon_id\` integer,
  	...
  	FOREIGN KEY (\`background_image_mobile_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null,
  	FOREIGN KEY (\`image_content_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`_pages_v_blocks_details_banner\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_details_banner_content_order_idx\` ON \`_pages_v_blocks_details_banner_content\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_details_banner_content_parent_id_idx\` ON \`_pages_v_blocks_details_banner_content\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_details_banner_content_icon_idx\` ON \`_pages_v_blocks_details_banner_content\` (\`icon_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_details_banner_content_background_image_idx\` ON \`_pages_v_blocks_details_banner_content\` (\`background_image_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_details_banner_content_background_image__idx\` ON \`_pages_v_blocks_details_banner_content\` (\`background_image_mobile_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_details_banner_content_image_content_idx\` ON \`_pages_v_blocks_details_banner_content\` (\`image_content_id\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_details_banner\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_details_banner_order_idx\` ON \`_pages_v_blocks_details_banner\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_details_banner_parent_id_idx\` ON \`_pages_v_blocks_details_banner\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_details_banner_path_idx\` ON \`_pages_v_blocks_details_banner\` (\`_path\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_form_custom_block\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_form_custom_block_order_idx\` ON \`_pages_v_blocks_form_custom_block\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_form_custom_block_parent_id_idx\` ON \`_pages_v_blocks_form_custom_block\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_form_custom_block_path_idx\` ON \`_pages_v_blocks_form_custom_block\` (\`_path\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_form_custom_block_icon_idx\` ON \`_pages_v_blocks_form_custom_block\` (\`icon_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_form_custom_block_form_idx\` ON \`_pages_v_blocks_form_custom_block\` (\`form_id\`);`)
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  await db.run(sql`DROP TABLE \`pages_blocks_mission_banner_images\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_mission_banner\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_welcome_banner_banner_labels\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_welcome_banner\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_details_banner_content\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_details_banner\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_form_custom_block\`;`)
  ...
  await db.run(sql`DROP TABLE \`_pages_v_blocks_mission_banner_images\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_mission_banner\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_welcome_banner_banner_labels\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_welcome_banner\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_details_banner_content\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_details_banner\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_form_custom_block\`;`)
