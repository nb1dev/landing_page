...
export const HeaderClient: React.FC<HeaderClientProps> = ({
  ...
  const css = `
    ...
    .nb1-loc-btn { display:inline-flex; align-items:center; gap:7px; font-family:inherit; font-size:13.5px; font-weight:600; color:${locBtnColor}; background:${locBtnBg}; border:1px solid ${locBtnBorder}; border-radius:100px; padding:7px 13px; cursor:pointer; transition:background .15s,border-color .15s; white-space:nowrap; }
    .nb1-loc-btn:hover { background:${isTransparent ? 'rgba(255,255,255,0.22)' : 'rgba(18,49,77,0.09)'}; }
